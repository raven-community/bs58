...
**Note:** If you're looking for **base 58 check** encoding, see: [https://github.com/raven-community/bs58check](https://github.com/raven-community/bs58check), which depends upon this library.
